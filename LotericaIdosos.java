...
public class LotericaIdosos {
    public static void main(String[] args) {
        ...
        // NOVO: Vetor que armazena os números da aposta

        int[] sorteado = {8, 17, 23, 34, 45, 59};
        // NOVO: Vetor para comparar os números sem depender da ordem

        boolean apostaRealizada = false;
        // NOVO: Verifica se o usuário já fez uma aposta
            ...
            case 2: 
             do { 
                    ...
                    switch (menu2) {
                        ...
                        aposta[0] = a1;
                        // NOVO: Salva o primeiro número no vetor
                        ...
                        aposta[5] = a6;
                        // NOVO: Salva o sexto número no vetor

                        if ((a1 > 0 && a1 < 61) &&  (a2 > 0 && a2 < 61) &&  (a3 > 0 && a3 < 61) &&  (a4 > 0 && a4 < 61) &&  (a5 > 0 && a5 < 61) &&  (a6 > 0 && a6 < 61)) {
                        boolean repetido = false;

                        // NOVO: Verifica se existem números repetidos
                        for(int i = 0; i < 6; i++){
                            for(int j = i + 1; j < 6; j++){
                        ...
                        if(repetido == true){
                            System.out.println("ERRO! Não é possível usar números repetidos.");
                        } else {
                        ...
                        // NOVO: Fecha validação de números repetidos
                        ...
                        numSorteio = (a1 + " " + a2 + " " + a3 + " " + a4 + " " + a5 + " " + a6);
                            ...
                            System.out.print("ERRO! Digite um número de 1 a 60.");
                        }
                        break;
                        ...
                        case 2: 
                            ...
                            // NOVO: Conta quantos números foram acertados independente da ordem
                            for(int i = 0; i < 6; i++){
                                for(int j = 0; j < 6; j++){
                            ...
                            // NOVO: Sistema de prêmio
                            if(acertos == 6){
                                System.out.println("PARABÉNS! Prêmio: R$ 1.000.000");
                            }
                            else if(acertos == 5){
                                System.out.println("Prêmio: R$ 5.000");
                            }
                            else if(acertos == 4){
                                System.out.println("Prêmio: R$ 500");
                            }
                            else{
